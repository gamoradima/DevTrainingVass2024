	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_mw7qdhj_caption)#",
					"visible": true,
					"clicked": {
						"request": "usr.RunWebServiceMaxPrice"
					},
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrColumn4_00bijud;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.PDS_UsrOfferType_erwvm8c;
					var offerTypeId = "";
					if (offerTypeObject) {
